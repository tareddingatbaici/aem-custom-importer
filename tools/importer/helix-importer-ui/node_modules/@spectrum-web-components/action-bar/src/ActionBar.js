"use strict";var u=Object.defineProperty;var c=Object.getOwnPropertyDescriptor;var s=(o,i,e,r)=>{for(var t=r>1?void 0:r?c(i,e):i,p=o.length-1,a;p>=0;p--)(a=o[p])&&(t=(r?a(i,e,t):a(t))||t);return r&&t&&u(i,e,t),t};import{html as f,SpectrumElement as d}from"@spectrum-web-components/base";import{property as l}from"@spectrum-web-components/base/src/decorators.js";import"@spectrum-web-components/popover/sp-popover.js";import"@spectrum-web-components/action-group/sp-action-group.js";import"@spectrum-web-components/button/sp-close-button.js";import"@spectrum-web-components/field-label/sp-field-label.js";import m from"./action-bar.css.js";import{ifDefined as n}from"@spectrum-web-components/base/src/directives.js";export const actionBarVariants=["sticky","fixed"];export class ActionBar extends d{constructor(){super(...arguments);this.emphasized=!1;this.flexible=!1;this.open=!1;this._variant=""}static get styles(){return[m]}set variant(e){if(e!==this.variant){if(actionBarVariants.includes(e)){this.setAttribute("variant",e),this._variant=e;return}this.removeAttribute("variant"),this._variant=""}}get variant(){return this._variant}handleClick(){this.open=!1,this.dispatchEvent(new Event("close",{bubbles:!0,composed:!0,cancelable:!0}))||(this.open=!0)}render(){return f`
        ...
        `}}s([l({type:Boolean,reflect:!0})],ActionBar.prototype,"emphasized",2),s([l({type:Boolean,reflect:!0})],ActionBar.prototype,"flexible",2),s([l({type:Boolean,reflect:!0})],ActionBar.prototype,"open",2),s([l({type:String})],ActionBar.prototype,"variant",1);
