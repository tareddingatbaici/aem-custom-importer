"use strict";var v=Object.defineProperty;var f=Object.getOwnPropertyDescriptor;var l=(d,o,e,t)=>{for(var i=t>1?void 0:t?f(o,e):o,r=d.length-1,s;r>=0;r--)(s=d[r])&&(i=(t?s(o,e,i):s(i))||i);return t&&i&&v(o,e,i),i};import{html as a,nothing as h,SizedMixin as g}from"@spectrum-web-components/base";import{property as n,query as p}from"@spectrum-web-components/base/src/decorators.js";import{classMap as c,ifDefined as y,repeat as m,styleMap as b}from"@spectrum-web-components/base/src/directives.js";import $ from"./slider.css.js";import{ObserveSlotText as k}from"@spectrum-web-components/shared/src/observe-slot-text.js";import"@spectrum-web-components/field-label/sp-field-label.js";import{HandleController as C}from"./HandleController.js";import{SliderHandle as P}from"./SliderHandle.js";import{streamingListener as N}from"@spectrum-web-components/base/src/streaming-listener.js";export const variants=["filled","ramp","range","tick"];export class Slider extends g(k(P,""),{noDefaultSize:!0,validSizes:["s","m","l","xl"]}){constructor(){super(...arguments);this.handleController=new C(this);this._editable=!1;this.hideStepper=!1;this.type="";this._variant="";this.getAriaValueText=e=>{const t=[...e.values()];return t.length===2?`${t[0]} - ${t[1]}`:t.join(", ")};this.min=0;this.max=100;this.step=1;this.tickStep=0;this.tickLabels=!1;this.disabled=!1;this.quiet=!1;this.indeterminate=!1;this._numberFieldInput=Promise.resolve()}static get styles(){return[$]}get editable(){return this._editable}set editable(e){if(e===this.editable)return;const t=this.editable;this._editable=this.handleController.size<2?e:!1,this.editable&&(this._numberFieldInput=import("@spectrum-web-components/number-field/sp-number-field.js")),t!==this.editable&&this.requestUpdate("editable",t)}set variant(e){const t=this.variant;e!==this.variant&&(variants.includes(e)&&this.fillStart===void 0?(this.setAttribute("variant",e),this._variant=e):(this.removeAttribute("variant"),this._variant=""),this.requestUpdate("variant",t))}get variant(){return this._variant}get values(){return this.handleController.values}get handleName(){return"value"}get ariaValueText(){return this.getAriaValueText?this.getAriaValueText(this.handleController.formattedValues):`${this.value}${this._forcedUnit}`}get numberFormat(){return this.getNumberFormat()}get focusElement(){return this.handleController.focusElement}handleLabelClick(e){this.editable&&(e.preventDefault(),this.focus())}render(){return a`
        ...
        `}connectedCallback(){super.connectedCallback(),this.handleController.hostConnected()}disconnectedCallback(){super.disconnectedCallback(),this.handleController.hostDisconnected()}update(e){this.handleController.hostUpdate(),e.has("disabled")&&this.disabled&&this.handleController.cancelDrag(),super.update(e)}renderLabel(){const e=this.labelVisibility==="none"||this.labelVisibility==="value",t=this.labelVisibility==="none"||this.labelVisibility==="text";return a`
            <div id="label-container">
                <sp-field-label
                    ...
                    size=${this.size}
                >
                    ${this.slotHasContent?h:this.label}
        ...
        `}renderTrackSegment(e,t){return this.variant==="ramp"?a``:a`
            <div
                ...
                role="presentation"
            ></div>
        `}getOffsetWidth(e,t){return Math.abs(t-e)/(this.max-this.min)*100}getOffsetPosition(e){return(e-this.min)/(this.max-this.min)*100}fillStyles(e){const t=this.dir==="rtl"?"right":"left",i=this.value>e?this.getOffsetPosition(e):this.getOffsetPosition(this.value),r=this.getOffsetWidth(e,this.value);return{[t]:`${i}%`,width:`${r}%`}}renderFillOffset(){return!this._cachedValue||!this.centerPoint?a``:a`
            <div
        ...
        `}handleDoubleClick(e){this.handleController.handleDoubleClick(e)}handlePointerdown(e){this.handleController.handlePointerdown(e)}handlePointermove(e){this.handleController.handlePointermove(e)}handlePointerup(e){this.handleController.handlePointerup(e)}handleNumberInput(e){var i;const{value:t}=e.target;if((i=e.target)!=null&&i.managedInput&&!isNaN(t)){this.value=t;return}e.stopPropagation()}handleNumberChange(e){var i;const{value:t}=e.target;isNaN(t)?(e.target.value=this.value,e.stopPropagation()):(this.value=t,(i=e.target)!=null&&i.managedInput||this.dispatchInputEvent()),this.indeterminate=!1}trackSegmentStyles(e,t){const i=t-e;return{width:`${i*100}%`,"--spectrum-slider-track-background-size":`${1/i*100}%`,"--spectrum-slider-track-segment-position":`${e*100}%`}}async getUpdateComplete(){const e=await super.getUpdateComplete();return this.editable&&(await this._numberFieldInput,await this.numberField.updateComplete),await this.handleController.handleUpdatesComplete(),e}willUpdate(e){e.has("value")&&e.has("fillStart")&&(this._cachedValue=Number(this.value),this.fillStart?this.centerPoint=Number(this.fillStart):this.centerPoint=(Number(this.max)-Number(this.min))/2+Number(this.min))}}l([n({type:Boolean,reflect:!0})],Slider.prototype,"editable",1),l([n({type:Boolean,reflect:!0,attribute:"hide-stepper"})],Slider.prototype,"hideStepper",2),l([n()],Slider.prototype,"type",2),l([n({reflect:!0})],Slider.prototype,"dir",2),l([n({type:String})],Slider.prototype,"variant",1),l([n({attribute:!1})],Slider.prototype,"getAriaValueText",2),l([n({type:String,reflect:!0,attribute:"label-visibility"})],Slider.prototype,"labelVisibility",2),l([n({type:Number,reflect:!0})],Slider.prototype,"min",2),l([n({type:Number,reflect:!0})],Slider.prototype,"max",2),l([n({type:Number})],Slider.prototype,"step",2),l([n({type:Number,attribute:"tick-step"})],Slider.prototype,"tickStep",2),l([n({type:Boolean,attribute:"tick-labels"})],Slider.prototype,"tickLabels",2),l([n({type:Boolean,reflect:!0})],Slider.prototype,"disabled",2),l([n({type:Number,reflect:!0,attribute:"fill-start"})],Slider.prototype,"fillStart",2),l([n({type:Boolean})],Slider.prototype,"quiet",2),l([n({type:Boolean})],Slider.prototype,"indeterminate",2),l([p("#label")],Slider.prototype,"labelEl",2),l([p("#number-field")],Slider.prototype,"numberField",2),l([p("#track")],Slider.prototype,"track",2);
